...
eval_runtime(xlab = NULL, ylab = "Runtime (s)",
             # scale_fill = scale_fill_manual(values = eval_color[1:6]),
             scale_fill = scale_fill_manual(values = eval_color[c(2, 7, 1, 3, 4)]),
             scale_linetype = scale_linetype_manual(values = c("solid", "dotted", "solid", "solid", "solid")),
             plot.margin = unit(c(4, 2, 1, 1.7), "mm"),
...
# Runtime vs. Accuracy ---------------------------------------------------------
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
eval_acc_vs_run(scale_color = scale_color_manual(values = eval_color_not_bw[c(4,1,2,5,3)]),
                plot.margin = unit(c(5, 2, 1, 1.7), "mm"),
